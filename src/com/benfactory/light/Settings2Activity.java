...
public class Settings2Activity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		infoButton1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				Builder alert = new AlertDialog.Builder(Settings2Activity.this);
	...
	private void displayDurationPicker(){
		...
		FullTimePickerDialog mTimePicker = new FullTimePickerDialog(Settings2Activity.this, new FullTimePickerDialog.OnTimeSetListener() {
